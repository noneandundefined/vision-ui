...
const Header = () => {
	return (
		<>
			<div className="bg-[#000] border-y-[1px] border-y-[#333] w-screen h-12 flex items-center px-10 justify-between">
				<div className="flex items-center gap-9">
					<div className="bg-[#ffffff2b] hover:bg-[#ffffff45] transition p-[5px] rounded-[7px] cursor-pointer"><Question fill='#fff' size={14} /></div>
					<div className="border border-[#ffffff2b] bg-[transparent] hover:bg-[#ffffff2b] transition p-1 px-4 rounded-[20px] cursor-pointer">
						<p className="text-[12px] font-medium tracking-wide">V1.1.2</p>
					</div>
				</div>
				...
				<div className="flex items-center gap-3">
					...
					<div className="h-[27px] w-[2px] bg-[#333]" />
